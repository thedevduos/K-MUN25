    ...
    <div className="min-h-screen">
      ...
      <section className="relative bg-gradient-to-br from-primary-900 via-primary-800 to-primary-700 text-white py-20 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          <div className="absolute bottom-10 right-10 w-96 h-96 bg-secondary-500/20 rounded-full blur-3xl"></div>
        </div>
          ...
          <div className="text-center">
            ...
            >
              <h1 className="text-4xl md:text-6xl font-bold mb-6">
                ...
                <span className="block text-2xl md:text-4xl text-primary-200 mt-2">
                  2025
                </span>
              </h1>
              ...
              <div className="flex flex-wrap justify-center items-center gap-6 text-primary-100 mb-12">
                <div className="flex items-center gap-2">
                  <Calendar className="w-5 h-5" />
                  <span>September 26-28, 2025</span>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  <Target className="w-6 h-6 text-primary-900 mt-1 flex-shrink-0" />
                  <div>
                ...
                <div className="flex items-start gap-3">
                  <Globe className="w-6 h-6 text-primary-900 mt-1 flex-shrink-0" />
                  <div>
              ...
              <Link
                to="/about"
                className="inline-flex items-center text-primary-900 hover:text-primary-950 font-medium transition-colors"
              >
            ...
            >
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-primary-800/20 to-transparent rounded-lg"></div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <Link
              to="/committees"
              className="bg-primary-900 text-white px-8 py-3 rounded-lg font-semibold hover:bg-primary-950 transition-colors"
            >
              View More Info
            </Link>
          </div>
